...
ANTHROPIC_API_KEY = PersistentConfig(
    "ANTHROPIC_API_KEY",
    "anthropic.api_key",
...
ENABLE_CHATGPT_API = PersistentConfig(
    "ENABLE_CHATGPT_API",
    "chatgpt.enable",
    os.environ.get("ENABLE_CHATGPT_API", "True").lower() == "true",
)

CHATGPT_API_KEY = PersistentConfig(
    "CHATGPT_API_KEY",
    "chatgpt.api_key",
...
ENABLE_GEMINI_CHAT_API = PersistentConfig(
    "ENABLE_GEMINI_CHAT_API",
    "gemini.chat.enable",
    os.environ.get("ENABLE_GEMINI_CHAT_API", "True").lower() == "true",
)

GEMINI_CHAT_API_KEY = PersistentConfig(
    "GEMINI_CHAT_API_KEY",
    "gemini.chat.api_key",
    os.environ.get("GEMINI_CHAT_API_KEY", os.environ.get("GEMINI_API_KEY", "")),
)
